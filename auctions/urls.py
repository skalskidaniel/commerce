...
urlpatterns = [
    ...
    path("view/<int:listing_id>/close", views.close_listing, name="close_listing"),
    path("view/<int:listing_id>/comment", views.add_comment, name="add_comment"),
    path("mylistings", views.user_listings, name="my_listings")
]
